            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form name="createBanners" id="createBanners" class="px-3"
                                    ...
                                    <div class="form-group row mb-3 align-center">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" id="banner_heading"
                                                name="banner_heading" value="" placeholder="Banner Heading" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3 align-center">
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-10">
                                            <textarea name="banner_text" class="form-control" placeholder="{{ __('Enter') }}.." required></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row mb-3 align-center">
    ...
    <script>
        window.addEventListener('load', function() {
            ...
            $('.save-btn').on('click', function(e) {
                ...
                let validator = validateForm($('form[name="createBanners"]'), {}, {})
                let url = $('#createBanners').attr('action')
                let method = $('#createBanners').attr('method')
                if (validator.form()) {
                    let formElement = $('form[name="createBanners"]')[0];
