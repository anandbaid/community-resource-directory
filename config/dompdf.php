...
return [
    ...
    */
    ...
    'options' => [
        ...
        'font_dir' => public_path('assets/fonts/'), // Store fonts in `public/`

        'font_cache' => storage_path('fonts/'), // Keep cache in storage

        'fonts' => [
            'poppins' => [
                'R'  => 'Poppins-Regular.ttf',  // Regular
                'SB' => 'Poppins-SemiBold.ttf', // SemiBold (Custom)
                'B' => 'Poppins-Bold.ttf', // SemiBold (Custom)
            ],
        ],
